...
class UserSessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_session" do
    assert_difference('UserSession.count') do
      post user_sessions_url, params: { user_session: { password: @user_session.password, username: @user_session.username } }
    end
  ...
  test "should update user_session" do
    patch user_session_url(@user_session), params: { user_session: { password: @user_session.password, username: @user_session.username } }
