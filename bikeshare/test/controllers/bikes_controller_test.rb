...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post bikes_url, params: { bike: { bike_code: @bike.bike_code, latitude: @bike.latitude, longitude: @bike.longitude, status: @bike.status } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { bike_code: @bike.bike_code, latitude: @bike.latitude, longitude: @bike.longitude, status: @bike.status } }
